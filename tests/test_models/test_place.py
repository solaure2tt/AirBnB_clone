...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_new_instance_stored_in_objects(self):
        """test if an instance is correctly store"""
    ...
    def test_two_places_unique_ids(self):
        """test if two places have differents ids"""
        pl1 = Place()
        pl2 = Place()
        self.assertNotEqual(pl1.id, pl2.id)

    def test_two_places_different_created_at(self):
        """test if 2 place have differents creation date"""
        pl1 = Place()
        sleep(0.05)
        pl2 = Place()
    ...
    def test_two_places_different_updated_at(self):
        """test if 2 places have different update date"""
        pl1 = Place()
        sleep(0.05)
        pl2 = Place()
    ...
    def test_str_representation(self):
        """test string represenation of a place"""
        dt = datetime.today()
        dt_repr = repr(dt)
        pl = Place()
        pl.id = "123456"
...
class TestPlace_save(unittest.TestCase):
    ...
    def tearDown(self):
        """delete a place created previuosly"""
        try:
            os.remove("file.json")
        except IOError:
            pass
    ...
    def test_two_saves(self):
        """test when place is save for the second time"""
        pl = Place()
        sleep(0.05)
        first_updated_at = pl.updated_at
        pl.save()
    ...
    def test_save_with_arg(self):
        """test save of place qith args"""
        pl = Place()
        with self.assertRaises(TypeError):
            pl.save(None)

    def test_save_updates_file(self):
        """test if file json is update when saving"""
        pl = Place()
        pl.save()
        plid = "Place." + pl.id
...
class TestPlace_to_dict(unittest.TestCase):
    ...
    def test_to_dict_type(self):
        """test dictionnary of place"""
        self.assertTrue(dict, type(Place().to_dict()))

    def test_to_dict_contains_correct_keys(self):
        """test if dict contains corrects keys"""
        pl = Place()
